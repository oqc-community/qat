...
> **⚠️ Warning:** Only the first {{ max_cases }} failures are shown. See the full report for more
> details. {% endif -%} {% for case in details.failure[:max_cases] %}
...
> **⚠️ Warning:** Only the first {{ max_cases }} errors are shown. See the full report for more
> details. {% endif -%} {% for case in details.error[:max_cases] %}
...
> **⚠️ Warning:** Only the first {{ max_cases }} skipped tests are shown. See the full report for
> more details. {% endif -%} {% for case in details.skipped[:max_cases] %}
