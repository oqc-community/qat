...
def define_live_qblox_variables(cluster_kit):
    if cluster_kit == 1:
        os.environ["QBLOX_DEV_IP"] = "172.16.2.100"
        os.environ["QBLOX_DEV_ID"] = "00015_2333_002"
        os.environ["QBLOX_DEV_NAME"] = "cluster1_mm"
    elif cluster_kit == 2:
        os.environ["QBLOX_DEV_IP"] = "172.16.3.40"
        os.environ["QBLOX_DEV_ID"] = "00015_2341_005"
        os.environ["QBLOX_DEV_NAME"] = "cluster2_mm"
    else:
...
def setup_qblox_hardware_model(
    model, cluster_kit=None, name=None
) -> QbloxControlHardware:
    ...
    if cluster_kit is None:
        ...
        define_live_qblox_variables(cluster_kit)
