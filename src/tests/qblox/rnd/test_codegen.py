...
from qat.purr.backends.qblox.rnd.instructions import (
    ReducedSweep,
    ReducedSweepValue,
    HybridInstructionBuilder,
)
...
def test_fast_resonator_spect(model):
    builder = _resonator_spect(model)
