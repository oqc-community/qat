...
class Constants:
    ...
    Max value allowed by assembler is 2**16-1, but this is the largest that is a multiple of
    4 ns.
    """
    ...
    """The maximum and minimum frequency expressed in steps for the NCO set_freq
    instruction.
    ...
    """Each QRM(-RF) module has a maximum of 3M memory bins.

    This memory can be dynamically allocated by each of the 6 sequencers. For example, all 6
    sequencers can evenly allocate 500K bins simultaneously or a single sequencers can
    allocate the whole 3M and leaves nothing for other sequencers
    """
    ...
    GRID_TIME = 4  # ns
    """Clock period of the sequencers.

    All time intervals used must be multiples of this value.
    """
