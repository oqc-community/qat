...
TODO(COMPILER-1422): Implement the experimental QBlox backend.
...
.. warning::
    ...
    implemented — COMPILER-1422 ("Write an experimental Qblox Backend pipeline") is still
    In Progress as of Sprint 36. This class exists so
    ...
    def emit(
        ...
        **kwargs,
        ...
        raise NotImplementedError(
            "Q1 lowering and QBlox code generation for the experimental pipeline are "
