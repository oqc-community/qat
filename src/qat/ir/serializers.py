...
class LegacyIRSerializer:
    ...
    def __init__(self, hardware_model: QuantumHardwareModel):
        ...
        The legacy way of serializing IR is to convert a QuantumInstructionBuilder into
    ...
    def serialize(self, builder: QuantumInstructionBuilder, indent: int = 4) -> str:
        """
        ...
        return pydantic_instructions.serialize(indent=indent)
