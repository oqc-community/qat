...
class FallthroughFrontend(BaseFrontend):
    """A frontend that passes through an input :class:`InstructionBuilder` and does not
    modify it.

    Used in situations where a frontend is not required, but is used to make a pipeline
    complete.
    """
