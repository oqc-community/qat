...
Then checkout back to the branch you are working and run :code:`poetry run pytest --benchmark-only --benchmark-save="benchmark" --benchmark-compare --benchmark-compare-fail=min:40%`.
