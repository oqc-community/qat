...
def logical_parse():
    ...
    print(builder)
    instructions = builder.instructions[0].instructions
    ...
    qasm_hw = get_default_qiskit_hardware(8)
    ...
    converted_builder = convert_to_other(output, qasm_hw)
    print(converted_builder.circuit)
