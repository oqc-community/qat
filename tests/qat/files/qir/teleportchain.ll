...
TeleportChain__DemonstrateTeleportationUsingPresharedEntanglement__body.1.exit: ; preds = %continue__1.i.i2.i, %then0__2.i.i3.i
  ...
  %4 = tail call i1 @__quantum__rt__result_equal(%Result* nonnull inttoptr (i64 4 to %Result*), %Result* nonnull inttoptr (i64 5 to %Result*))
  %5 = sext i1 %4 to i8
  ret i8 %5
}
...
declare %String* @__quantum__rt__bool_to_string(i1) local_unnamed_addr
...
attributes #0 = { "EntryPoint" "InteropFriendly" "requiredQubits"="6" }
