...
def bell_state(measurements: bool = True):
    """
    Generates a bell state |00> + |11> in QASM.
    """
...
def ghz_state(num_qubits: int, measurements: bool = True):
    """
    Generates a ghz state |0...0> + |1...1> in QASM.
    """
