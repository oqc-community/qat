...
_expected_q1_op_names = {
    ...
    "q1.i.stop",
    "q1.ii.fb_acq_iq_id",
    "q1.ii.fb_acq_iq_shift",
    "q1.ii.fb_acq_tb_id",
    "q1.ii.fb_acq_tb_valid",
    "q1.ii.set_awg_gain",
    "q1.ii.set_awg_offs",
    "q1.iii.fb_acq_tb_extra",
    "q1.iii.fb_cmd",
    "q1.iii.fb_com_data",
    "q1.iii.fb_com_extra",
    "q1.iiii.fb_acq_tb_cfg",
    "q1.iiii.fb_acq_tb_mock",
    "q1.iiii.fb_com_cfg",
    "q1.iiii.set_cond",
    "q1.ir.fb_pop_data",
    "q1.ir.move",
    ...
    "q1.iii.acquire",
    "q1.iri.acquire",
    "q1.iiiii.acquire_weighed",
    "q1.irrri.acquire_weighed",
    "q1.iiii.acquire_ttl",
    "q1.irii.acquire_ttl",
    "q1.iiiii.acquire_timetags",
    "q1.iriri.acquire_timetags",
    "q1.iii.acquire_digital",
    "q1.iri.acquire_digital",
    "q1.iii.upd_thres",
    "q1.iri.upd_thres",
}
